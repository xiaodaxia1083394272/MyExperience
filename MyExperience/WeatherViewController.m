...
@interface WeatherViewController ()<JuHeServiceDelegate,UIScrollViewDelegate>
...
-(void)initDataScrollView{
    ...
    int index = 0;
    CGFloat space = 0;
    for (NSString *dateString in _dateList) {
        ...
        [self.weatherDateView updatView:dateString isSelected:NO index:index];
